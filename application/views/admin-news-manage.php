        ...
        <div id="main-container" class="clear-float">
            ...
            <aside>
                <ul>
                    ...
                    <li class="active"><a href="admin-news-manage.html">新闻管理</a></li>
                </ul>
            </aside>
            <article>
                <table>
                    ...
                    <tbody>
                        <tr data-id="#">
                            ...
                            <td>一根筷子引发的血案</td>
                            <td>
                                <a href="news-edit.html?id=12"><button class="news-edit">编辑</button></a>
                                <button class="news-delete">删除</button>
                            </td>
                        </tr>
                        <tr data-id="#">
                            <td>12</td>
                ...
                <div class="btns">
                    <a href="news-edit.html"><button>新建新闻</button></a>
                </div>
            </article>
        </div>
