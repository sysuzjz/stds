...
Date.prototype.format = function(c, a) {
    ...
    c.widget("metro.carousel", {
        ...
        _create: function() {
            ...
            if (! (1 >= this._slides.length)) { ! 1 !== this.options.markers && (this.options.markers.show && 1 < this._slides.length) && this._markers(a);
    ...
    c.widget("metro.slider", {
        ...
        _placeMarker: function(a) {
            ...
            f && (f = Math.round(b / g) - 1, k.css("background-color", e.colors[0 > f ? 0 : f])),
            e.showHint && this._animate(l.html(Math.round(a)).css("left", c - l.width() / 2), {
                left: b - l.width() / 2
            })
        },
...
$(function() {
    ...
    d = {
        ...
        _hide: function() {
            this.clear();
            return void 0 != this._notify ? (this._notify.hide("slow",
            function() {
                this.remove();
